    ...
    <div class="grid grid-cols-4 gap-4">
      <div class="col-span-4 md:col-span-2 lg:col-span-1">
        <div class="flex-auto">
          ...
          <InputText
            fluid
            :invalid="v$.form.rec_brand.$error"
            v-model.trim="v$.form.rec_brand.$model"
      ...
      <div class="col-span-4 md:col-span-2 lg:col-span-1">
        <div class="flex-auto">
          ...
          <InputText
            fluid
            :invalid="v$.form.module_capacity.$error"
            v-model.trim="v$.form.module_capacity.$model"
            aria-describedby="module_capacity"
          />
        </div>
      ...
      <div class="col-span-4 md:col-span-2 lg:col-span-1">
        <div class="flex-auto">
          ...
          <InputText
            fluid
            :invalid="v$.form.no_module.$error"
            v-model.trim="v$.form.no_module.$model"
      ...
      <div class="col-span-4 md:col-span-2 lg:col-span-1">
        <div class="flex-auto">
          ...
          <InputText
            fluid
            :invalid="v$.form.pld_value.$error"
            v-model.trim="v$.form.pld_value.$model"
      ...
      <div class="col-span-4 md:col-span-2 lg:col-span-1">
        <div class="flex-auto">
          ...
          <Select
            fluid
            :invalid="v$.form.net_eco.$error"
            :options="net_eco_options"
            v-model.trim="v$.form.net_eco.$model"
            aria-describedby="net_eco"
          >
          </Select>
        </div>
      ...
      <div class="col-span-4 md:col-span-2 lg:col-span-1">
        <div class="flex-auto">
          <label class="font-bold" id="net_eco_activation"
            >Net Eco Activation</label
          >
          <InputText
            fluid
            :invalid="v$.form.net_eco_activation.$error"
            v-model.trim="v$.form.net_eco_activation.$model"
            aria-describedby="net_eco_activation"
          />
        </div>
        <div v-if="v$.form.net_eco_activation.$error">
          <validationErrorMessage
            :errors="v$.form.net_eco_activation.$errors"
          />
        </div>
      </div>
  ...
  methods: {
    mountData() {
      if (this.dialogRef.data.action == "Update") {
        ...
        this.form.net_eco_activation =
          this.dialogRef.data.rowData.net_eco_activation;
      ...
      this.$confirm.require({
        ...
        accept: async () => {
          ...
          if (this.action == "Update") {
            ...
            Sites.updateRectifierDetails(this.form)
              .then((response) => {
            ...
            Sites.insertRectifierDetails(this.form)
              .then((response) => {
