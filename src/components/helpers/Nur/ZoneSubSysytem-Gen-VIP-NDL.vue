...
const getSiteCodeAndName = (event) => {
  if (event.NUR3G[0].problem_site_name) {
    site_name.value = event.NUR3G[0].problem_site_name;
    site_code.value = event.NUR3G[0].problem_site_code;
  } else if (event.NUR4G[0].problem_site_name) {
    site_name.value = event.NUR4G[0].problem_site_name;
    site_code.value = event.NUR4G[0].problem_site_code;
  } else if (event.NUR2G[0].problem_site_name) {
    site_name.value = event.NUR2G[0].problem_site_name;
    site_code.value = event.NUR2G[0].problem_site_code;
  }
};
...
const getVipSitesNUR = () => {
  ...
  NUR.getVipSitesWeeklyNUR(props.zone, props.zoneWeek, props.zoneYear).then(
    (response) => {
...
const getNodalSitesNUR = () => {
  ...
  NUR.getNodalSitesWeeklyNUR(props.zone, props.zoneWeek, props.zoneYear).then(
    (response) => {
      if (response.data.sites.length > 0) {
        sites = response.data.sites;
        dialog.open(VipsOrNodals, {
