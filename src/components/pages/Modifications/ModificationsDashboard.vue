  ...
  <div class="w-screen-2xl px-10 py-20">
    <Card class="max-w-screen-xl mx-auto">
      ...
      <template #content>
        ...
        <MeterGroup :value="meter_value" labelPosition="start">
        ...
        <div class="w-full flex justify-evenly gap-1 flex-wrap">
          ...
          <div class=" w-full flex-shrink-0 justify-center items-center">
            ...
            <BarChart :chartDataSets="subcontractorChartData" chartTitle="Work Orders Cost" 
            chartId="workOrders" />
          </div>
...
const modificationsDashboard = () => {
  Modifications.modificationDashboard(props.year).then((response) => {
   ...
   subcontractorChartData.value= mountSubcontractorChartData(response.data.dashboard.subcontractor);
